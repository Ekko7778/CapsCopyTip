...
ShowSettings(*) {
    ...
    settingsGui.SetFont("Norm")
    settingsGui.ctl_pos2 := settingsGui.Add("Radio", "x20 y239 w280 +Group" . (tipPosition = 2 ? " Checked" : ""), "屏幕中央")
    settingsGui.ctl_pos1 := settingsGui.Add("Radio", "x20 y266 w100" . (tipPosition = 1 ? " Checked" : ""), "跟随鼠标")
    ...
    settingsGui.ctl_pos3 := settingsGui.Add("Radio", "x20 y293 w100" . (tipPosition = 3 ? " Checked" : ""), "屏幕顶部")
    settingsGui.ctl_topOffset := settingsGui.Add("Edit", "x200 y290 w60 h22 Number", tipTopOffset)
    settingsGui.Add("Text", "x265 y293", "px")
    settingsGui.ctl_pos4 := settingsGui.Add("Radio", "x20 y320 w100" . (tipPosition = 4 ? " Checked" : ""), "屏幕底部")
