...
| 小写 + 中文 | 大写 + 英文 | 复制提示 |
|:-----------:|:-----------:|:--------:|
| ![](images/preview-lowercase-cn.png) | ![](images/preview-uppercase-en.png) | ![](images/preview-copy.jpg) |

### 设置界面

右键托盘图标可打开设置窗口，支持功能开关、显示时长、提示位置、外观样式等自定义。

![](images/preview-settings.png)
